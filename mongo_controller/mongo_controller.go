...
var userCollection *mongo.Collection = db.GetCollection(db.MongoDB, "users")
...
func CreateUser() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		c.JSON(http.StatusCreated, models.UserResponse{Status: http.StatusCreated, Message: "success", Data: map[string]interface{}{"data": result}})
	}
}
	...
	return func(c *gin.Context) {
		...
		if result.DeletedCount < 1 {
			c.JSON(http.StatusNotFound,
				models.UserResponse{Status: http.StatusNotFound, Message: "error", Data: map[string]interface{}{"data": "User with specified ID not found!"}},
			)
			return
		}

		c.JSON(http.StatusOK,
			models.UserResponse{Status: http.StatusOK, Message: "success", Data: map[string]interface{}{"data": "User successfully deleted!"}},
		)
	}
}
...
func GetAllUsers() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		c.JSON(http.StatusOK,
			models.UserResponse{Status: http.StatusOK, Message: "success", Data: map[string]interface{}{"data": users}},
		)
	}
}
